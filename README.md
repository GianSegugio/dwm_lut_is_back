...
- **Improved UI**: In-grid SDR/HDR LUT dropdowns per monitor with NXT (cycle) / DEL (remove) actions, a live per-monitor Status (inactive / active windowed / active fullscreen), and a global Apply/Disable hotkey.
